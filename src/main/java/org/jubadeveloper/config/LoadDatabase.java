...
class LoadDatabase {
    ...
    CommandLineRunner initDatabase () {
        return args -> {
            log.info("Preloading " + employeeService.create(new Employee("Juan", EmployeeStatus.ACTIVE)));
            log.info("Preloading " + employeeService.create(new Employee("Marquito", EmployeeStatus.ACTIVE)));
        };
    }
}